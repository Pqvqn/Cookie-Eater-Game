...
public class SpriteLevel extends Sprite{
	...
	public void updateStuff(ArrayList<Wall> w, boolean fast) throws IOException {
		wallList = w;
		...
		if(board.currLevel.bgImg==null || fast) {
			if(!fast) {
