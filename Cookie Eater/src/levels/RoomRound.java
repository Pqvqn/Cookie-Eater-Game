...
public class RoomRound extends Level{
	...
	public RoomRound(Game frame, Board gameboard, String id) {
		this(frame,gameboard,id,null);
	}
	public RoomRound(Game frame, Board gameboard, String id, ArrayList<Level> nextFloor) {
