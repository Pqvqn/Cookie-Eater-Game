...
public class Room3 extends Level{
	...
	public Room3(Game frame, Board gameboard, String id) {
		this(frame,gameboard,id,null);
	}
	public Room3(Game frame, Board gameboard, String id, ArrayList<Level> nextFloor) {
	...
	public Room3(Game frame, Board gameboard, ArrayList<Level> prev, ArrayList<Level> next, SaveData sd) {
